...
setup(
    ...
    data_files=[
        ...
        (os.path.join('share', package_name, 'launch'), glob(os.path.join('launch', '*launch.[pxy][yma]*'))), # for launch files
        (os.path.join('share', package_name, 'media'), glob('media/*.mp4')), # for video simulation
    ],
    install_requires=[ \
        'setuptools', 'rclpy', 'sensor_msgs', 'geometry_msgs', 'std_msgs', 'cv_bridge'],
    zip_safe=True,
    maintainer='root',
