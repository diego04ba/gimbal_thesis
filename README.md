...
My first ROS2 automated project. Given a certain reference, the camera (in my case the FFY-U3-16S2C-CS, FLIR firefly S) has to follow it by giving a Gimbal (BGC 2.2 (2.2b2)) control commands.  
